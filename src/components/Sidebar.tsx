...
const Sidebar = () => {
  ...
  return (
    <>
      <aside className=" shadow-[5px_0px_20px_rgba(0,0,0,0.04)] pt-[7.4375rem] pb-1 lg:block md:hidden sm:hidden overflow-y-auto -mt-2 h-[calc(100vh-0.75rem)]  ">
        <button className="flex gap-1 items-center text-[#213f7d] text-base ml-[1.4rem] mb-[3.3125rem]">
